...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationRead.unread'
        db.add_column('dashboard_notificationread', 'unread', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationRead.unread'
        db.delete_column('dashboard_notificationread', 'unread')
    ...
    models = {
        ...
        'dashboard.notificationread': {
            'Meta': {'object_name': 'NotificationRead'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lasttime_read': ('django.db.models.fields.DateTimeField', [], {}),
