...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NotificationRead'
        db.create_table('dashboard_notificationread', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('lasttime_read', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('dashboard', ['NotificationRead'])


    def backwards(self, orm):
        
        # Deleting model 'NotificationRead'
        db.delete_table('dashboard_notificationread')
