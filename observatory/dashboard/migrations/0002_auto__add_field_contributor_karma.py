...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contributor.karma'
        db.add_column('dashboard_contributor', 'karma', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contributor.karma'
        db.delete_column('dashboard_contributor', 'karma')
